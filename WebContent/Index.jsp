...
<div class="i_bg bg_color">
	<div class="i_ban_bg">
        ...
        <div class="inews">
        	<div class="news_t">
            	<span class="fr"><a href="news?data=paging&index=1">更多 ></a></span>新闻资讯
            </div>           
            <ul>
	            <c:choose>
	            	...
	            	<c:otherwise>
	            		<c:forEach var="li" items="${news }">
            				<c:choose>
            					<c:when test="${li.id mod 2 eq 0 }">
            						<li><span>[ 公告 ]</span><a href="#">${li.title }</a></li>
            					</c:when>
            					<c:otherwise>
            						<li><span>[ 特惠 ]</span><a href="#">${li.title }</a></li>
            					</c:otherwise>
            				</c:choose>
	            		</c:forEach>
	            	</c:otherwise>
    ...
    <div class="content mar_10">
    	<div class="h_l_img">
        	<div class="img"><a href="toProductServlet?id=1"><img src="images/l_img.jpg" width="188" height="188" /></a></div>
            <div class="pri_bg">
                            ...
                            <ul class="featureUL">
                                <li class="featureBox">
                                    <div class="box">
                                        ...
                                        <div class="imgbg">
                                        	<a href="toProductServlet?id=2"><img src="images/hot1.jpg" width="160" height="136" /></a>
                                        </div>                                        
                                        <div class="name">
                                        	<a href="#">
                                            <h2>德国进口</h2>
                                ...
                                <li class="featureBox">
                                    <div class="box">
                                        <div class="h_icon"><img src="images/hot.png" width="50" height="50" /></div>
                                        <div class="imgbg">
                                        	<a href="toProductServlet?id=3"><img src="images/hot2.jpg" width="160" height="136" /></a>
                                        </div>                                        
                                        <div class="name">
                                        	<a href="#">
                                            <h2>iphone 6S</h2>
                                ...
                                <li class="featureBox">
                                    <div class="box">
                                        <div class="h_icon"><img src="images/hot.png" width="50" height="50" /></div>
                                        <div class="imgbg">
                                        	<a href="toProductServlet?id=4"><img src="images/hot3.jpg" width="160" height="136" /></a>
                                        </div>                                        
                                        <div class="name">
                                        	<a href="#">
                                            <h2>倩碧特惠组合套装</h2>
                                ...
                                <li class="featureBox">
                                    <div class="box">
                                        <div class="h_icon"><img src="images/hot.png" width="50" height="50" /></div>
                                        <div class="imgbg">
                                        	<a href="toProductServlet?id=5"><img src="images/hot4.jpg" width="160" height="136" /></a>
                                        </div>                                        
                                        <div class="name">
                                        	<a href="#">
                                            <h2>品利特级橄榄油</h2>
