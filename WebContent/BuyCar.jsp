...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    $(function(){
        $(".car_btn_1").click(function(){
            ...
            var price = $(this).prev().prev().val();//单价
            if(c=="1"){
                c=1;
            }else{
                c--;
    ...
    <div class="content mar_20">
    	<table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
          ...
          <c:forEach var="li" items="${buycar }">
          	<tr class="car_tr">
            <td>
            	<div class="c_s_img"><img src="${li.product.filename }" width="73" height="73" /></div>
            ...
            <td align="center">
            	<div class="c_num">
                	...
                	<input type="text" value="${li.count }" name="" class="car_ipt" />  
                    <input type="button" value="" class="car_btn_2" />
                </div>
            </td>
            <td align="center" style="color:#ff4e00;">￥${li.product.price }</td>
            <td align="center">26R</td>
            <td align="center"><a href="buyCarHandleServlet?id=${li.id }&type=delete">删除</a>&nbsp; &nbsp;<a href="#">加入收藏</a></td>
          </tr>
          </c:forEach>
          ...
          <tr height="70">
          	<td colspan="6" style="font-family:'Microsoft YaHei'; border-bottom:0;">
                ...
                <span class="fr">商品总价：
                	<b style="font-size:22px; color:#ff4e00;" id="sumprice">￥
          ...
          <tr valign="top" height="150">
          	<td colspan="6" align="right">
            	<a href="Index.jsp"><img src="images/buy1.gif" /></a>&nbsp; &nbsp; <a href="buyCarTwoServlet"><img src="images/buy2.gif" /></a>
            </td>
          </tr>
        </table>
