		...
		<div class="m_right">
    		...
    		${login.id }
              ...
              <tr>
                ...
                <td>
         <c:choose>
    		<c:when test="${ empty login.identitycode }">
    			<c:out value="对不起,该页面无数据" />
    		</c:when>
    		<c:otherwise>
    		${login.identitycode }
              ...
              <tr>
                ...
                <td>
     			<c:choose>
    		<c:when test="${ empty login.mobile }">
    			<c:out value="对不起,该页面无数据" />
    		</c:when>
    		<c:otherwise>
    		${login.mobile }
              ...
              <tr>
                ...
                <td>
     	<c:choose>
    		<c:when test="${ empty login.email }">
    			<c:out value="对不起,该页面无数据" />
    		</c:when>
    		<c:otherwise>${login.email }</c:otherwise>
    	</c:choose>               
